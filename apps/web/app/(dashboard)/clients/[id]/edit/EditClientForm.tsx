  ...
  return (
    <div className="p-4 md:p-8 max-w-2xl">
      <div className="flex items-center gap-2 md:gap-3 mb-6">
        <a href={`/clients/${client.id}`} className="text-gray-400 hover:text-gray-600">
          ← К клиенту
        </a>
        <h1 className="text-2xl font-bold">Редактировать клиента</h1>
      </div>
      <form onSubmit={handleSubmit} className="bg-white border rounded-xl p-6 space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            placeholder="Особенности, режим работы, договорённости..."
            className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-2">
          ...
          <a
            ...
            className="px-6 py-2 rounded-lg text-sm border hover:bg-gray-50 inline-flex items-center justify-center"
          >
            Отмена
          </a>
        </div>
